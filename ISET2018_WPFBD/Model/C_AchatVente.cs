...
namespace ISET2018_WPFBD.Model
{
    ...
    public class C_AchatVente
    {
        ...
        public C_AchatVente()
        { }
        public C_AchatVente(int idVoiture_, int idClient_, int prixOperation_, DateTime dateOperation_, int idPaiement_, string typeOperation_)
        {
        ...
        public C_AchatVente(int idOperation_, int idVoiture_, int idClient_, int prixOperation_, DateTime dateOperation_, int idPaiement_, string typeOperation_)
